...
public class QuantityMeasurementApp
{
    static void Main(string[] args)
    {
        ...
        // Demonstrate runtime type checking with Equals
        WriteLine("Runtime Type Checking with Equals():");
        var lengthForCompare1 = new Quantity<LengthUnit>(10.0, LengthUnit.Feet);
        var weightForCompare1 = new Quantity<WeightUnit>(5.0, WeightUnit.Kilogram);
        var volumeForCompare1 = new Quantity<VolumeUnit>(2.0, VolumeUnit.Litre);

        WriteLine($"10 ft equals 5 kg? {lengthForCompare1.Equals(weightForCompare1)}");
        WriteLine($"10 ft equals 2 L? {lengthForCompare1.Equals(volumeForCompare1)}");
        WriteLine($"5 kg equals 2 L? {weightForCompare1.Equals(volumeForCompare1)}");
        WriteLine();
