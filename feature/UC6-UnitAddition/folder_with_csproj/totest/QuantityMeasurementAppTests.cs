...
public class QuantityMeasurementAppTests
{
 ...
 //uc5 tests
    ...
    public void TestAddition_Service_SameUnit()
    {
        ...
        var result = QuantityMeasurementApp.QuantityMeasurementService.Add(CreateQuantity(2.0,QuantityMeasurementApp.LengthUnit.Feet),CreateQuantity(3.0,QuantityMeasurementApp.LengthUnit.Feet));
        Assert.AreEqual(5.0,result.Value,0.0001);
    }
    ...
    public void TestAddition_Service_CrossUnit()
    {
        ...
        var result = QuantityMeasurementApp.QuantityMeasurementService.Add(CreateQuantity(1.0,QuantityMeasurementApp.LengthUnit.Feet),CreateQuantity(12.0,QuantityMeasurementApp.LengthUnit.Inch));
        Assert.AreEqual(2.0,result.Value,0.0001);
    }
    ...
    public void TestAddition_Service_WithTargetUnit()
    {
        ...
        var result = QuantityMeasurementApp.QuantityMeasurementService.Add(1.0,QuantityMeasurementApp.LengthUnit.Feet,12.0,QuantityMeasurementApp.LengthUnit.Inch,QuantityMeasurementApp.LengthUnit.Feet);
        Assert.AreEqual(2.0,result.Value,0.0001);
        Assert.AreEqual(QuantityMeasurementApp.LengthUnit.Feet,result.Unit);
    }
    ...
    public void TestAddition_Service_WithTargetUnitInches()
    {
        ...
        var result = QuantityMeasurementApp.QuantityMeasurementService.Add(1.0,QuantityMeasurementApp.LengthUnit.Feet,12.0,QuantityMeasurementApp.LengthUnit.Inch,QuantityMeasurementApp.LengthUnit.Inch);
        Assert.AreEqual(24.0,result.Value,0.0001);
        Assert.AreEqual(QuantityMeasurementApp.LengthUnit.Inch,result.Unit);
    }
    ...
    public void TestAddition_Service_WithTargetUnitYards()
    {
        ...
        var result = QuantityMeasurementApp.QuantityMeasurementService.Add(1.0,QuantityMeasurementApp.LengthUnit.Yards,3.0,QuantityMeasurementApp.LengthUnit.Feet,QuantityMeasurementApp.LengthUnit.Yards);
        Assert.AreEqual(2.0,result.Value,0.0001);
        Assert.AreEqual(QuantityMeasurementApp.LengthUnit.Yards,result.Unit);
    }
