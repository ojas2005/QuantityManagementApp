...
public class QuantityMeasurementAppTests
{
    ...
    #endregion
    #region Temperature Unit Tests

    private Quantity<TemperatureUnit> CreateTemperature(double value, TemperatureUnit unit)
    {
    ...
    {
        Assert.That(CreateTemperature(0.0, TemperatureUnit.Celsius).Equals(CreateTemperature(0.0, TemperatureUnit.Celsius)), Is.True);
    }

    [Test]
    public void TestTemperatureEquality_FahrenheitToFahrenheit_SameValue()
    {
        Assert.That(CreateTemperature(32.0, TemperatureUnit.Fahrenheit).Equals(CreateTemperature(32.0, TemperatureUnit.Fahrenheit)), Is.True);
    }

    [Test]
    public void TestTemperatureEquality_CelsiusToFahrenheit_0Celsius32Fahrenheit()
    {
        Assert.That(CreateTemperature(0.0, TemperatureUnit.Celsius).Equals(CreateTemperature(32.0, TemperatureUnit.Fahrenheit)), Is.True);
    }

    [Test]
    public void TestTemperatureEquality_CelsiusToFahrenheit_100Celsius212Fahrenheit()
    {
        Assert.That(CreateTemperature(100.0, TemperatureUnit.Celsius).Equals(CreateTemperature(212.0, TemperatureUnit.Fahrenheit)), Is.True);
    }

    [Test]
    public void TestTemperatureEquality_CelsiusToFahrenheit_Negative40Equal()
    {
        Assert.That(CreateTemperature(-40.0, TemperatureUnit.Celsius).Equals(CreateTemperature(-40.0, TemperatureUnit.Fahrenheit)), Is.True);
    }

    [Test]
    public void TestTemperatureEquality_SymmetricProperty()
    {
        var a = CreateTemperature(0.0, TemperatureUnit.Celsius);
        var b = CreateTemperature(32.0, TemperatureUnit.Fahrenheit);
    ...
    {
        var temp = CreateTemperature(50.0, TemperatureUnit.Celsius);
    ...
    {
        Assert.That(CreateTemperature(100.0, TemperatureUnit.Celsius).ConvertTo(TemperatureUnit.Fahrenheit), 
            Is.EqualTo(212.0).Within(0.001));
    }

    [Test]
    public void TestTemperatureConversion_FahrenheitToCelsius()
    {
        Assert.That(CreateTemperature(32.0, TemperatureUnit.Fahrenheit).ConvertTo(TemperatureUnit.Celsius), 
    ...
    {
        var original = CreateTemperature(25.0, TemperatureUnit.Celsius);
        var inFahrenheit = original.To(TemperatureUnit.Fahrenheit);
        var back = inFahrenheit.To(TemperatureUnit.Celsius);
        Assert.That(back.Value, Is.EqualTo(original.Value).Within(0.001));
    }

    [Test]
    public void TestTemperatureConversion_SameUnit()
    {
        Assert.That(CreateTemperature(25.0, TemperatureUnit.Celsius).ConvertTo(TemperatureUnit.Celsius), 
            Is.EqualTo(25.0).Within(0.001));
    }

    [Test]
    public void TestTemperatureConversion_ZeroValue()
    {
        Assert.That(CreateTemperature(0.0, TemperatureUnit.Celsius).ConvertTo(TemperatureUnit.Fahrenheit), 
            Is.EqualTo(32.0).Within(0.001));
    }

    [Test]
    public void TestTemperatureConversion_NegativeValues()
    {
        Assert.That(CreateTemperature(-40.0, TemperatureUnit.Celsius).ConvertTo(TemperatureUnit.Fahrenheit), 
    ...
    {
        var temp1 = CreateTemperature(100.0, TemperatureUnit.Celsius);
        var temp2 = CreateTemperature(50.0, TemperatureUnit.Celsius);
        
        var ex = Assert.Throws<NotSupportedException>(() => temp1.Add(temp2));
        Assert.That(ex.Message, Does.Contain("Temperature does not support ADD"));
    }
    ...
    public void TestTemperatureUnsupportedOperation_Subtract()
    {
        ...
        Assert.That(ex.Message, Does.Contain("Temperature does not support SUBTRACT"));
    }
    ...
    public void TestTemperatureUnsupportedOperation_Divide()
    {
        ...
        Assert.That(ex.Message, Does.Contain("Temperature does not support DIVIDE"));
    }

    [Test]
    public void TestTemperatureVsLengthIncompatibility()
    {
        Assert.That(CreateTemperature(100.0, TemperatureUnit.Celsius).Equals(CreateLength(100.0, LengthUnit.Feet)), Is.False);
    }

    [Test]
    public void TestTemperatureVsWeightIncompatibility()
    {
        Assert.That(CreateTemperature(50.0, TemperatureUnit.Celsius).Equals(CreateWeight(50.0, WeightUnit.Kilogram)), Is.False);
    }

    [Test]
    public void TestTemperatureVsVolumeIncompatibility()
    {
        Assert.That(CreateTemperature(25.0, TemperatureUnit.Celsius).Equals(CreateVolume(25.0, VolumeUnit.Litre)), Is.False);
    }

    [Test]
    public void TestTemperatureNullComparison()
    {
        Assert.That(CreateTemperature(100.0, TemperatureUnit.Celsius).Equals(null), Is.False);
    }

    [Test]
    public void TestTemperatureDifferentValuesInequality()
    {
        Assert.That(CreateTemperature(50.0, TemperatureUnit.Celsius).Equals(CreateTemperature(100.0, TemperatureUnit.Celsius)), Is.False);
    }

    [Test]
    public void TestTemperatureValidation_NegativeAllowed()
    {
        Assert.DoesNotThrow(() => CreateTemperature(-50.0, TemperatureUnit.Celsius));
    }

    [Test]
    public void TestTemperatureValidation_NaNValue_Throws()
    {
        Assert.Throws<ArgumentException>(() => CreateTemperature(double.NaN, TemperatureUnit.Celsius));
    }

    [Test]
    public void TestTemperatureToString_Celsius()
    {
        Assert.That(CreateTemperature(25.5, TemperatureUnit.Celsius).ToString(), Is.EqualTo("25.5 °C"));
    }

    [Test]
    public void TestTemperatureToString_Fahrenheit()
    {
        Assert.That(CreateTemperature(77.0, TemperatureUnit.Fahrenheit).ToString(), Is.EqualTo("77 °F"));
    }

    [Test]
    public void TestTemperatureHashCode_EqualObjects()
    {
        var celsius = CreateTemperature(0.0, TemperatureUnit.Celsius);
        var fahrenheit = CreateTemperature(32.0, TemperatureUnit.Fahrenheit);
        Assert.That(celsius.GetHashCode(), Is.EqualTo(fahrenheit.GetHashCode()));
    }
