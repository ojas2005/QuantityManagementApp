...
public class QuantityMeasurementApp
{
    static void Main(string[] args)
    {
        ...
        try
        {
            var invalidSub = new Quantity<LengthUnit>(10.0, LengthUnit.Feet).Subtract(new Quantity<WeightUnit>(5.0, WeightUnit.Kilogram) as Quantity<LengthUnit>);
        }
        catch (Exception ex)
        {
            WriteLine($"Cross-category subtraction prevented: {ex.Message}");
        }
