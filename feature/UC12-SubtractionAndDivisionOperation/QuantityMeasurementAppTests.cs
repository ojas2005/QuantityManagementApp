...
public class QuantityMeasurementAppTests
{
    ...
    [Test]
    public void TestAddition_Commutativity111()
    {
        var a = CreateVolume(1.0, VolumeUnit.Litre);
        var b = CreateVolume(1000.0, VolumeUnit.Millilitre);
        var r1 = a.Add(b);
    ...
    [Test]
    public void TestAddition_WithZero11()
    {
    ...
    public void TestAddition_SmallValues()
    {
        ...
        Assert.That(result.Value, Is.EqualTo(0.003).Within(0.0001));
    }
    ...
    [Test]
    public void TestOperator_EqualityOperator_CrossUni1()
    {
        Assert.That(CreateVolume(1.0, VolumeUnit.Litre) == CreateVolume(1000.0, VolumeUnit.Millilitre), Is.True);
    }

    [Test]
    public void TestOperator_InequalityOperator1()
    {
    ...
    {
        var result = CreateLength(5.0, LengthUnit.Feet).Subtract(CreateLength(10.0, LengthUnit.Feet));
        Assert.That(result.Value, Is.EqualTo(-5.0));
        Assert.That(result.Unit, Is.EqualTo(LengthUnit.Feet));
    }
    ...
    {
        var result = CreateLength(5.0, LengthUnit.Feet).Subtract(CreateLength(-2.0, LengthUnit.Feet));
        Assert.That(result.Value, Is.EqualTo(7.0));
        Assert.That(result.Unit, Is.EqualTo(LengthUnit.Feet));
    }
    ...
    {
        var result = CreateLength(0.001, LengthUnit.Feet).Subtract(CreateLength(0.0005, LengthUnit.Feet));
        Assert.That(result.Value, Is.EqualTo(0.0005).Within(0.0001));
    }
