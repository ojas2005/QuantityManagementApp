...
public static class LengthUnitHelper
{
    ...
    {
        { LengthUnit.Feet, new LengthUnitImpl(1.0, "ft", false) },
        { LengthUnit.Inch, new LengthUnitImpl(1.0 / 12.0, "in", false) },
        { LengthUnit.Yards, new LengthUnitImpl(3.0, "yd", false) },
        { LengthUnit.Centimeters, new LengthUnitImpl(0.0328084, "cm", false) }
    };
    ...
    private class LengthUnitImpl : IMeasurable
    {
        ...
        public bool IsValidValue(double value) => !double.IsNaN(value) && !double.IsInfinity(value) && (_allowNegative || value >= 0);
    }
}