...
public class QuantityMeasurementAppTests
{
 ...
 //uc5 tests
    ...
    private QuantityMeasurementApp.QuantityWeight CreateWeight(double value,WeightUnit? unit)
    {
    ...
    {
        var kg1 = CreateWeight(1.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(1.0,WeightUnit.Kilogram);
        Assert.IsTrue(kg1.Equals(kg2));
    }
    ...
    {
        var kg1 = CreateWeight(1.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(2.0,WeightUnit.Kilogram);
        Assert.IsFalse(kg1.Equals(kg2));
    }

    [Test]
    public void TestEquality_GramToGram_SameValue()
    {
        var g1 = CreateWeight(500.0,WeightUnit.Gram);
        var g2 = CreateWeight(500.0,WeightUnit.Gram);
    ...
    {
        var lb1 = CreateWeight(2.0,WeightUnit.Pound);
        var lb2 = CreateWeight(2.0,WeightUnit.Pound);
        Assert.IsTrue(lb1.Equals(lb2));
    }

    [Test]
    public void TestEquality_KilogramToGram_EquivalentValue()
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var g = CreateWeight(1000.0,WeightUnit.Gram);
    ...
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var lb = CreateWeight(2.20462,WeightUnit.Pound);
    ...
    {
        var g = CreateWeight(453.592,WeightUnit.Gram);
        var lb = CreateWeight(1.0,WeightUnit.Pound);
        Assert.IsTrue(g.Equals(lb));
    }

    [Test]
    public void TestEquality_WeightVsLength_Incompatible()
    {
        var weight = CreateWeight(1.0,WeightUnit.Kilogram);
        var length = CreateQuantity(1.0,LengthUnit.Feet);
    ...
    [Test]
    public void TestEquality_WeightSameReference()
    {
        var weight = CreateWeight(1.0,WeightUnit.Kilogram);
    ...
    [Test]
    public void TestEquality_WeightNullUnit()
    {
        Assert.Throws<ArgumentException>(() =>
            CreateWeight(1.0,null));
    }

    [Test]
    public void TestEquality_WeightTransitiveProperty()
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var g = CreateWeight(1000.0,WeightUnit.Gram);
        var lb = CreateWeight(2.20462,WeightUnit.Pound);
    ...
    [Test]
    public void TestEquality_WeightZeroValue()
    {
        var kg0 = CreateWeight(0.0,WeightUnit.Kilogram);
        var g0 = CreateWeight(0.0,WeightUnit.Gram);
        Assert.IsTrue(kg0.Equals(g0));
    }

    [Test]
    public void TestEquality_WeightNegativeValue()
    {
        var kgNeg = CreateWeight(-1.0,WeightUnit.Kilogram);
        var gNeg = CreateWeight(-1000.0,WeightUnit.Gram);
        Assert.IsTrue(kgNeg.Equals(gNeg));
    }

    [Test]
    public void TestEquality_WeightLargeValue()
    {
        var gLarge = CreateWeight(1000000.0,WeightUnit.Gram);
        var kgLarge = CreateWeight(1000.0,WeightUnit.Kilogram);
        Assert.IsTrue(gLarge.Equals(kgLarge));
    }

    [Test]
    public void TestEquality_WeightSmallValue()
    {
        var kgSmall = CreateWeight(0.001,WeightUnit.Kilogram);
        var gSmall = CreateWeight(1.0,WeightUnit.Gram);
        Assert.IsTrue(kgSmall.Equals(gSmall));
    }
    ...
    {
        var lb = CreateWeight(2.20462,WeightUnit.Pound);
        double result = lb.ConvertTo(WeightUnit.Kilogram);
        Assert.AreEqual(1.0,result,0.001);
    }
    ...
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        double result = kg.ConvertTo(WeightUnit.Pound);
        Assert.AreEqual(2.20462,result,0.001);
    }
    ...
    {
        var g = CreateWeight(1000.0,WeightUnit.Gram);
        double result = g.ConvertTo(WeightUnit.Kilogram);
        Assert.AreEqual(1.0,result,0.0001);
    }
    ...
    {
        var g = CreateWeight(453.592,WeightUnit.Gram);
        double result = g.ConvertTo(WeightUnit.Pound);
        Assert.AreEqual(1.0,result,0.001);
    }
    ...
    {
        var kg = CreateWeight(5.0,WeightUnit.Kilogram);
        double result = kg.ConvertTo(WeightUnit.Kilogram);
        Assert.AreEqual(5.0,result,0.0001);
    }
    ...
    {
        var kg0 = CreateWeight(0.0,WeightUnit.Kilogram);
        double result = kg0.ConvertTo(WeightUnit.Gram);
        Assert.AreEqual(0.0,result,0.0001);
    }
    ...
    {
        var kgNeg = CreateWeight(-1.0,WeightUnit.Kilogram);
        double result = kgNeg.ConvertTo(WeightUnit.Gram);
        Assert.AreEqual(-1000.0,result,0.0001);
    }
    ...
    {
        var kg = CreateWeight(1.5,WeightUnit.Kilogram);
        double toGram = kg.ConvertTo(WeightUnit.Gram);
        var gWeight = CreateWeight(toGram,WeightUnit.Gram);
        double backToKg = gWeight.ConvertTo(WeightUnit.Kilogram);
        Assert.AreEqual(1.5,backToKg,0.0001);
    }
    ...
    public void TestAddition_SameUnit_KilogramPlusKilogram()
    {
        var kg1 = CreateWeight(1.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(2.0,WeightUnit.Kilogram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg1,kg2);
        Assert.AreEqual(3.0,result.Value,0.0001);
    ...
    public void TestAddition_CrossUnit_KilogramPlusGram()
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var g = CreateWeight(1000.0,WeightUnit.Gram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg,g);
        Assert.AreEqual(2.0,result.Value,0.0001);
        Assert.AreEqual(WeightUnit.Kilogram,result.Unit);
    }
    ...
    public void TestAddition_CrossUnit_GramPlusKilogram()
    {
        var g = CreateWeight(1000.0,WeightUnit.Gram);
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(g,kg);
    ...
    public void TestAddition_CrossUnit_PoundPlusKilogram()
    {
        var lb = CreateWeight(2.20462,WeightUnit.Pound);
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(lb,kg);
        Assert.AreEqual(4.40924,result.Value,0.001);
    ...
    public void TestAddition_ExplicitTargetUnit_Gram()
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var g = CreateWeight(1000.0,WeightUnit.Gram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg,g,WeightUnit.Gram);
        Assert.AreEqual(2000.0,result.Value,0.0001);
        Assert.AreEqual(WeightUnit.Gram,result.Unit);
    }
    ...
    {
        var g1 = CreateWeight(500.0,WeightUnit.Gram);
        var g2 = CreateWeight(1500.0,WeightUnit.Gram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(g1,g2,WeightUnit.Kilogram);
        Assert.AreEqual(2.0,result.Value,0.0001);
        Assert.AreEqual(WeightUnit.Kilogram,result.Unit);
    }
    ...
    public void TestAddition_ExplicitTargetUnit_Pound()
    {
        var kg1 = CreateWeight(1.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(1.0,WeightUnit.Kilogram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg1,kg2,WeightUnit.Pound);
        Assert.AreEqual(4.40924,result.Value,0.001);
        Assert.AreEqual(WeightUnit.Pound,result.Unit);
    }
    ...
    public void TestAddition_Commutativity()
    {
        ...
        var result1 = QuantityMeasurementApp.QuantityWeight.Add(kg,g,WeightUnit.Kilogram);
        var result2 = QuantityMeasurementApp.QuantityWeight.Add(g,kg,WeightUnit.Kilogram);
        
        Assert.AreEqual(result1.Value,result2.Value,0.0001);
    }

    [Test]
    public void TestAddition_WithZerWeight()
    {
        var kg = CreateWeight(5.0,WeightUnit.Kilogram);
        var g0 = CreateWeight(0.0,WeightUnit.Gram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg,g0);
        Assert.AreEqual(5.0,result.Value,0.0001);
    }
    ...
    {
        var kg = CreateWeight(5.0,WeightUnit.Kilogram);
        var gNeg = CreateWeight(-2000.0,WeightUnit.Gram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg,gNeg);
        Assert.AreEqual(3.0,result.Value,0.0001);
    }
    ...
    {
        var kg1 = CreateWeight(1000000.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(1000000.0,WeightUnit.Kilogram);
        var result = QuantityMeasurementApp.QuantityWeight.Add(kg1,kg2);
        Assert.AreEqual(2000000.0,result.Value,0.1);
    }

    [Test]
    public void TestWeightOperator_Equality()
    {
        var kg1 = CreateWeight(1.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(1.0,WeightUnit.Kilogram);
    ...
    [Test]
    public void TestWeightOperator_Inequality()
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        var g = CreateWeight(500.0,WeightUnit.Gram);
        Assert.IsTrue(kg != g);
    }
    ...
    {
        var kg = CreateWeight(5.5,WeightUnit.Kilogram);
        Assert.AreEqual("5.5 kg",kg.ToString());
        
        var g = CreateWeight(250.0,WeightUnit.Gram);
        Assert.AreEqual("250 g",g.ToString());
        
        var lb = CreateWeight(10.5,WeightUnit.Pound);
        Assert.AreEqual("10.5 lb",lb.ToString());
    }

    [Test]
    public void TestWeightHashCode()
    {
        var kg1 = CreateWeight(1.0,WeightUnit.Kilogram);
        var kg2 = CreateWeight(1.0,WeightUnit.Kilogram);
        Assert.AreEqual(kg1.GetHashCode(),kg2.GetHashCode());
    }

    [Test]
    public void TestWeightValidation_InvalidValue()
    {
        Assert.Throws<ArgumentException>(() =>
            CreateWeight(double.NaN,WeightUnit.Kilogram));
        
        Assert.Throws<ArgumentException>(() =>
            CreateWeight(double.PositiveInfinity,WeightUnit.Kilogram));
    }

    [Test]
    public void TestWeightAdditionNullCheck()
    {
        var kg = CreateWeight(1.0,WeightUnit.Kilogram);
        
        Assert.Throws<ArgumentNullException>(() =>
            QuantityMeasurementApp.QuantityWeight.Add(null,kg));
        
        Assert.Throws<ArgumentNullException>(() =>
            QuantityMeasurementApp.QuantityWeight.Add(kg,null));
    }
}
